...
# If symlink does not exist, create a dir /var/www/domains/ and a symlink to /myproject/ dir
if ! [ -L /var/www/domains/myproject ]; then 
    mkdir -p /var/www/domains
    ln -s /vagrant /var/www/domains/myproject
fi
...
cp -n /var/www/domains/myproject/conf/mysql/my.cnf /home/vagrant/.my.cnf
cp -n /var/www/domains/myproject/conf/mysql/my.cnf /root/.my.cnf

# Create logs folder
mkdir -p /vagrant/myproject/logs/
...
if ! [ -L /etc/apache2/sites-enabled/myproject-jpdev.conf ]; then
    ln -s /var/www/domains/myproject/conf/apache/myproject-jpdev.conf /etc/apache2/sites-enabled/myproject-jpdev.conf
fi
